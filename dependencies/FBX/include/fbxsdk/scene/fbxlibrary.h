...
protected:
	...
	FbxLibrary(FbxManager& pManager, const char* pName);
    ...
    template < class T > T* FbxLibrary::InstantiateMember( const T* pFBX_TYPE, const FbxObjectFilter& pFilter, bool pRecurse, FbxObject* pOptContainer )
    {
        ...
        if( pRecurse )
        {
            ...
            for( i = 0; i < GetMemberCount( FBX_TYPE(FbxLibrary) ); ++i )
            {
                FbxLibrary* lLibrary = GetMember( FBX_TYPE(FbxLibrary), i );
...
///////////////////////////////////////////////////////////////////////////////
  ...
  /** \class FbxEventPopulateSystemLibrary
    * \nosubgrouping
    ...
    */
    ...
    /** \class FbxEventUpdateSystemLibrary
	  * \nosubgrouping
