...
public:
    ...
    */
    ...
    bool IsBoundingBoxInView( const FbxMatrix& pWorldToScreen, 
                             ...
                             const FbxVector4 pPoints[8] ) const;
    ...
    /** Compute the perspective matrix for this camera. 
      ...
      */
    FbxMatrix ComputePerspective(int pPixelWidth, int pPixelHeight, bool pIncludePostPerspective) const;
	...
	/** Calculate the up vector.
	  ...
	  */
	FbxVector4 ComputeUpVector(const FbxVector4& pCameraPosition, const FbxVector4& pLookAtPosition) const;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    friend class FbxGlobalCameraSettings;

    virtual FbxObject& Copy(const FbxObject& pObject);

protected:
    FbxCamera(FbxManager& pManager, char const* pName);
