...
private:
    ...
    bool ComputeTangents(FbxVector4* pPolyVetices, FbxVector2* pUvs, int pPolySize, FbxArray<FbxVector4> &pTan1, FbxArray<FbxVector4> &pTan2);
...
protected:
    ...
    FbxMesh(FbxManager& pManager, char const* pName);
...
protected:
    ...
    void PolySetTexture(FbxLayer* pLayer, int pTextureIndex,
                        FbxLayerElement::EType pTextureType);
    template<class T> bool GetPolygonVertexLayerElementValue(const FbxLayerElementTemplate<T>* pLayerElement,
