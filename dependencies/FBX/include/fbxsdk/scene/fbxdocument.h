    ...
    */
    //@{
        ...
        /** Find a member object in the document, that has the given type and name.
		  ...
		  */
        template <class T> inline T*       FindRootMember(const T* pfbxType, char* pName) { return Roots.FindSrcObject(pfbxType, pName); }
        ...
        /** Return the number of objects of class T in the document.
		  ...
		  * \return The number of objects of class T in the document.
		  */
        template < class T > inline int     GetRootMemberCount (const T* pFBX_TYPE) const { return Roots.GetSrcObjectCount(T::ClassId); }
        ...
        /** Return the member of class T of the document at given index.
		  ...
		  * \param pIndex Selection index.
		  */
        template < class T > inline T*      GetRootMember (const T* pFBX_TYPE, int pIndex=0) const  { return (T*)Roots.GetSrcObject(T::ClassId,pIndex); }
