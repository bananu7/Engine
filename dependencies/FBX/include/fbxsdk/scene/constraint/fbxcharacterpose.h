...
private:
    FbxCharacterPose(FbxManager& pManager, char const* pName);

    virtual void Destruct(bool pRecursive, bool pDependents);

    void CopyNode(FbxNode* pSrcNode, FbxNode* pDstNode);
    void CopyCharacter(FbxCharacter* pSrcCharacter, FbxCharacter* pDstCharacter, FbxNode* pDstRootNode);
