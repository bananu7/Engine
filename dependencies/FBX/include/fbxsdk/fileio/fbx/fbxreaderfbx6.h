...
private:
    ...
    /** Read exposure control from file
      *	\param pExposureControl         exposure control object to fill
      * \return if reading exposure control is successful return \c true, otherwise return \c false.
      */
    bool ReadExposureControl(FbxExposureControl& pExposureControl);
    //@}
...
private:
    ...
    FbxObjectStringMap         mNodeAttributeMap;
