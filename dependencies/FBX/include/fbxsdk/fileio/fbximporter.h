...
public:
	...
	/** Initialize object.
      ...
      * \remarks                  You do not need to give the pFileFormat if the suffix of pFileName is recognized
      */
	virtual bool Initialize(FbxFile* pFile, const int pFileFormat=-1, FbxIOSettings* pIOSettings=NULL);

	/** Get the file, if any.
	   * \return The file or NULL if the file has not been set.
	   */
	virtual FbxFile * GetFile();
#endif 
...
///////////////////////////////////////////////////////////////////////////////
	...
	/** Get FBX file Axis information and FBX file System units
	  *	\param pAxisSystem    pointer to a FbxAxisSystem object
	  *	\param pSystemUnits    pointer to a FbxSystemUnit object
	  *	\return     \c true on success, \c false otherwise.
	  *	\remarks    This function must be called after FbxImporter::Initialize().
	  */
	...
	/** Get FBX file Statistics informations.
	  ...
	  *	\param pStatistics    pointer to a FbxStatistics object
	  *	\return     \c true on success, \c false otherwise.
	  *	\remarks    This function must be called after FbxImporter::Initialize().
	  */
...
protected:
	...
	FbxImporter(FbxManager& pManager,char const* pName);
