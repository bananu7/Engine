...
#define FBXSDK_INTRUSIVE_LIST_NODE(classT, NodeCount)\
    public: inline FbxListNode<classT>& GetListNode(int index = 0){ return this->mNode[index]; }\
    private:  FbxListNode<classT> mNode[NodeCount];
