...
//@{
    ...
    /** Get the FbxAnimCurve from the specified animation layer.
      ...
      *         is returned.
     */
    template <class T> inline T* GetCurve(FbxAnimLayer* pAnimLayer, bool pCreateAsNeeded=false)
    {
        return FbxCast<T>(GetCurve(pAnimLayer, GetName(), NULL, pCreateAsNeeded));
    }
    ...
    /** Get the FbxAnimCurve from the specified animation layer.
      ...
      *         is returned.
     */
    template <class T> inline T* GetCurve(FbxAnimLayer* pAnimLayer, const char* pChannel, bool pCreateAsNeeded=false)
    {
        return FbxCast<T>(GetCurve(pAnimLayer, GetName(), pChannel, pCreateAsNeeded));
    }
     ...
     */
    template <class T> inline T* GetCurve(FbxAnimLayer* pAnimLayer, const char* pName, const char* pChannel, bool pCreateAsNeeded=false)
    {
        return FbxCast<T>(GetCurve(pAnimLayer, pName, pChannel, pCreateAsNeeded));
    }
//@}
...
//@{
    ...
    /** Disconnects this property from all the source objects of a specific class type.
      ...
      * \return \c True if it disconnects all the source objects successfully, \c false otherwise.
      */
    bool	DisconnectAllSrcObject(const FbxClassId& pClassId);
    ...
    /** Disconnects this property from all the source objects of a specific class type that satisfy the given criteria.
      ...
      * \return \c True if it disconnects all the source objects successfully, \c false otherwise.
      */
    bool	DisconnectAllSrcObject(const FbxClassId& pClassId, const FbxCriteria& pCriteria);
    ...
    /** Returns the number of source objects of the specific class type with which this property connects. 
      ...
      */
    int		GetSrcObjectCount(const FbxClassId& pClassId) const;
    ...
    /** Returns the number of source objects which are of the specified class type and satisfy the given criteria with which this property connects.
      ...
      */
    int		GetSrcObjectCount(const FbxClassId& pClassId, const FbxCriteria& pCriteria) const;
    ...
    /** Returns the source object of the specified class type at the specified index with which this property connects.
      ...
      */
    FbxObject*		GetSrcObject(const FbxClassId& pClassId, int pIndex=0) const;
    ...
    /** Returns the source object which is of the specified class type and satisfies the given criteria at the specified index.
      ...
      */
    FbxObject*		GetSrcObject(const FbxClassId& pClassId, const FbxCriteria& pCriteria, int pIndex=0) const;
    ...
    /** Searches the source object with the specified name which is of the specified class type, starting with the specified index.
      ...
      * \return The source object with the name, NULL if not found.
      */
    FbxObject*		FindSrcObject(const FbxClassId& pClassId, const char* pName, int pStartIndex=0) const;
    ...
    /** Searches the source object with the specified name which is of the specified class type and satisfies the given criteria, starting with the specified index.
      ...
      * \return The source object with the name, NULL if not found.
      */
    FbxObject*		FindSrcObject(const FbxClassId& pClassId, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const;
    ...
    /** Disconnects this property from all source objects of the specified class type.
      ...
      */
    template < class T > inline bool DisconnectAllSrcObject (const T*){ return DisconnectAllSrcObject(T::ClassId);}
    ...
    /** Disconnects this property from all source objects which are of the specified class type and satisfy the given criteria.
      ...
      * \return \c True if it disconnects all source objects successfully, \c false otherwise.
      */
    template < class T > inline bool DisconnectAllSrcObject (const T*, const FbxCriteria& pCriteria)  { return DisconnectAllSrcObject(T::ClassId,pCriteria);  }
    ...
    /** Returns the number of source objects of a specific class type with which this property connects. 
      ...
      */
    template < class T > inline int  GetSrcObjectCount(const T*) const{ return GetSrcObjectCount(T::ClassId); }
    ...
    /** Returns the number of source objects which are of the specified class type and satisfy the given criteria with which this property connects. 
      ...
      */
    template < class T > inline int  GetSrcObjectCount(const T*, const FbxCriteria& pCriteria) const { return GetSrcObjectCount(T::ClassId,pCriteria); }
    ...
    /** Returns the source object of the specified class type at the specified index.
      ...
      */
    template < class T > inline T*   GetSrcObject(const T*, int pIndex=0) const { return (T*)GetSrcObject(T::ClassId,pIndex); }
    ...
    /** Returns the source object which is of the specified class type and satisfies the given criteria at the specified index.
      ...
      * \return The source object which is of the specified class type and satisfies the given criteria at the specified index, NULL if not found.
      */
    template < class T > inline T*   GetSrcObject(const T*, const FbxCriteria& pCriteria,int pIndex=0) const { return (T*)GetSrcObject(T::ClassId,pCriteria,pIndex); }
    ...
    /** Searches the source object with the specified name which is of the specified class type, starting with the specified index.
      ...
      * \return The source object with the name, NULL if not found.
      */
    template < class T > inline T*   FindSrcObject(const T*, const char* pName, int pStartIndex=0) const { return (T*)FindSrcObject(T::ClassId,pName,pStartIndex); }
    ...
    /** Searches the source object with the specified name which is of the specified class type and satisfies the given criteria, starting with the specified index.
      ...
      * \return The source object with the name, NULL if not found.
      */
    template < class T > inline T*   FindSrcObject(const T*, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const { return (T*)FindSrcObject(T::ClassId,pCriteria,pName,pStartIndex); }
    ...
    /** Disconnects this property from all the destination objects of the specified class type.
      ...
      * \return \c True if it disconnects all the destination objects successfully, \c false otherwise.
      */
    bool	DisconnectAllDstObject(const FbxClassId& pClassId);
    ...
    /** Disconnects this property from all the destination objects which are of the specified class type and satisfy the given criteria.
      ...
      * \return \c True if it disconnects all the destination objects successfully, \c false otherwise.
      */
    bool	DisconnectAllDstObject(const FbxClassId& pClassId, const FbxCriteria& pCriteria);
    ...
    /** Returns the number of destination objects of the specified class type with which this property connects. 
      ...
      */
    int		GetDstObjectCount(const FbxClassId& pClassId) const;
    ...
    /** Returns the number of destination objects which are of the specified class type and satisfy the given criteria with which this property connects. 
      ...
      */
    int		GetDstObjectCount(const FbxClassId& pClassId, const FbxCriteria& pCriteria) const;
    ...
    /** Returns the destination object of the specified class type at the specified index with which this property connects.
      ...
      */
    FbxObject*		GetDstObject(const FbxClassId& pClassId, int pIndex=0) const;
    ...
    /** Returns the destination object which is of the specified class type and satisfies the given criteria at the specified index with which this property connects.
      ...
      */
    FbxObject*		GetDstObject(const FbxClassId& pClassId, const FbxCriteria& pCriteria, int pIndex=0) const;
    ...
    /** Searches the destination object with the specified name which is of the specified class type, starting with the specified index.
      ...
      * \return The destination object with the name, NULL if not found.
      */
    FbxObject*		FindDstObject(const FbxClassId& pClassId, const char* pName, int pStartIndex=0) const;
    ...
    /** Searches the destination object with the specified name which is of the specified class type and satisfies the given criteria, starting with the specified index.
      ...
      * \return The destination object with the name, NULL if not found.
      */
    FbxObject*		FindDstObject(const FbxClassId& pClassId, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const;

    /** Disconnects this property from all the destination objects of the specified class type.
      * \param pFBX_TYPE The specified class type.
      * \return \c True if it disconnects all the destination objects successfully, \c false otherwise.
      */
    template < class T > inline bool DisconnectAllDstObject (const T*){ return DisconnectAllDstObject(T::ClassId);    }
    ...
    /** Disconnects this property from all the destination objects which are of the specified class type and satisfy the given criteria.
      ...
      * \return \c True if it disconnects all the destination objects successfully, \c false otherwise.
      */
    template < class T > inline bool DisconnectAllDstObject (const T*, const FbxCriteria& pCriteria)  { return DisconnectAllDstObject(T::ClassId,pCriteria);  }

    /** Returns the number of destination objects of the specified class type with which this property connects. 
      * \param pFBX_TYPE The specified class type.
      * \return The number of destination objects of the specified class type with which this property connects. 
      */
    template < class T > inline int  GetDstObjectCount(const T*) const { return GetDstObjectCount(T::ClassId); }
    ...
    /** Returns the number of destination objects which are of the specified class type and satisfy the given criteria with which this property connects. 
      ...
      */
    template < class T > inline int  GetDstObjectCount(const T*, const FbxCriteria& pCriteria) const { return GetDstObjectCount(T::ClassId,pCriteria); }
    ...
    /** Returns the destination object of the specified class type at the specified index with which this property connects.
      ...
      * \return The destination object of the specified class type at the specified index, NULL if not found.
      */
    template < class T > inline T*   GetDstObject(const T*, int pIndex=0) const { return (T*)GetDstObject(T::ClassId,pIndex); }
    ...
    /** Returns the destination object which is of the specified class type and satisfies the given criteria at the specified index with which this property connects.
      ...
      * \return The destination object which is of the specified class type and satisfies the given criteria at the specified index, NULL if not found.
      */
    template < class T > inline T*   GetDstObject(const T*, const FbxCriteria& pCriteria, int pIndex=0) const { return (T*)GetDstObject(T::ClassId,pCriteria,pIndex); }
    ...
    /** Searches the destination object with the specified name which is of the specified class type, starting with the specified index.
      ...
      * \return The source object with the name, NULL if not found.
      */
    template < class T > inline T*   FindDstObject(const T*, const char* pName, int pStartIndex=0) const { return (T*)FindDstObject(T::ClassId,pName,pStartIndex); }
    ...
    /** Searches the destination object with the specified name which is of the specified class type and satisfies the given criteria, starting with the specified index.
      ...
      * \return The source object with the name, NULL if not found.
      */
    template < class T > inline T*   FindDstObject(const T*, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const { return (T*)FindDstObject(T::ClassId,pCriteria,pName,pStartIndex); }
//@}
	...
	//@{
		...
		/** Connects this property to a destination property.
		  ...
		  * \return \c True on success, \c false otherwise.
		  */
		bool ConnectDstProperty(FbxProperty const&  pProperty);
...
public:
    ...
    template < class T > inline T*  GetSrcIfObject(const T*) const { return mSrc->IsRoot() ? FbxCast<T>(mSrc->GetFbxObject()) : (T*)0; }
    template < class T > inline T*  GetDstIfObject(const T*) const { return mDst->IsRoot() ? FbxCast<T>(mDst->GetFbxObject()) : (T*)0; }
