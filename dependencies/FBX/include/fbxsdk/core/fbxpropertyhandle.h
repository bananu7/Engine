...
public:
	...
	*/
	...
	/** Create an instance with given name and type.
	  ...
	  * \param pType
	  */
	static FbxTypeInfoHandle	Create(const char* pName, EFbxType pType=eFbxUndefined);

	/** Create an instance with given name and type info.
	  * \param pName
	  * \param pTypeInfo
	  */
	static FbxTypeInfoHandle	Create(const char* pName, FbxTypeInfoHandle pTypeInfo);
	...
	*/
	...
	FbxTypeInfoHandle	GetTypeInfo() const;
	...
	*/
	FbxPropertyHandle	Add(const char* pName, const FbxTypeInfoHandle& pTypeInfo);
	...
	* \return  Return a property handle which be created with the found property   
	*/
	FbxPropertyHandle	Find(const char* pName, const FbxTypeInfoHandle& pTypeInfo, bool pCaseSensitive) const;
	...
	* \return  Return a property handle which be created with the found property   
	*/
	FbxPropertyHandle	Find(const char* pName, const char* pChildrenSeparator, const FbxTypeInfoHandle& pTypeInfo, bool pCaseSensitive) const;
	//@}
