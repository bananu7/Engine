...
public:
	...
	//@{
		...
		/** Constructor.
		  ...
		  */
		FbxDataType(const FbxTypeInfoHandle& pTypeInfoHandle);
	...
	/** Retrieve the information handle of this data type.
	  ...
	  */
	inline const FbxTypeInfoHandle& GetTypeInfoHandle() const { return mTypeInfoHandle; }

private:
	FbxTypeInfoHandle mTypeInfoHandle;
