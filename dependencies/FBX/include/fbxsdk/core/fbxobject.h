...
#define FBXSDK_OBJECT_DECLARE(Class, Parent)									\
	FBXSDK_PLUG_DECLARE(Class)		/* this also set public */					\
...
#define FBXSDK_ABSTRACT_OBJECT_DECLARE(Class, Parent)							\
	FBXSDK_ABSTRACT_PLUG_DECLARE(Class)	/* this also set public */				\
	typedef Parent ParentClass;													\
private:																		\
	Class(const Class&);														\
	Class& operator=(const Class&);												\
...
#define FBXSDK_OBJECT_IMPLEMENT(Class)											\
    FBXSDK_PLUG_IMPLEMENT(Class)												\
	Class* Class::Create(FbxObject* pContainer, const char* pName)				\
	{																			\
		if( !pContainer ) return NULL;											\
		FbxManager* Manager = pContainer->GetFbxManager();						\
		FBX_ASSERT(Manager);													\
		Class* ClassPtr = 0;													\
		ClassPtr = (Class*)Manager->CreateNewObjectFromClassId(Class::ClassId,	\
			pName, pContainer);													\
		return ClassPtr;														\
	}																			\
...
#define FBXSDK_ABSTRACT_OBJECT_IMPLEMENT(Class)									\
    FBXSDK_ABSTRACT_PLUG_IMPLEMENT(Class)										\

class FbxObject_internal;
...
/** The base class of most FBX objects. Provides the benefits of connectivity, identity, run-time typing,
  ...
  *
  * The FbxObject class inherits from FbxPlug, which allows objects to be differentiated via the ClassId mechanism. 
  ...
  * MyObject = NULL;
  * \endcode
  * \see FbxPlug, FbxProperty
  */
class FBXSDK_DLL FbxObject : public FbxPlug
{
	FBXSDK_OBJECT_DECLARE(FbxObject, FbxPlug);
...
public:
	...
	//@{
		...
		/** Returns the root property of this object.
		  ...
		  */
		inline FbxProperty& GetRootProperty() { return RootProperty; }

		/** Returns the root property of this object.
		  * \return The root property.
		  */
		inline const FbxProperty& GetRootProperty() const { return RootProperty; }
	...
	//@{
		...
		/** Disconnects this object from all source objects of a specific class type.
		  ...
		  * \return \c True if it disconnects all source objects successfully, \c false otherwise.
		  */
		inline bool DisconnectAllSrcObject(FbxClassId pClassId) { return RootProperty.DisconnectAllSrcObject(pClassId); }
		...
		/** Disconnects this object from all source objects that satisfy a given criteria and that are a specific class type.
		  ...
		  */
		inline bool DisconnectAllSrcObject(FbxClassId pClassId, const FbxCriteria& pCriteria) { return RootProperty.DisconnectAllSrcObject(pClassId,pCriteria); }
		...
		/** Returns the number of source objects of the specific class type with which this object connects. 
		  ...
		  */
		inline int GetSrcObjectCount(FbxClassId pClassId) const { return RootProperty.GetSrcObjectCount(pClassId); }
		...
		/** Returns the number of source objects that satisfy the given criteria and that are the specified class type.
		  ...
		  */
		inline int GetSrcObjectCount(FbxClassId pClassId, const FbxCriteria& pCriteria) const { return RootProperty.GetSrcObjectCount(pClassId,pCriteria); }
		...
		/** Returns the source object of the specified class type at the specified index with which this object connects.
		  ...
		  */
		inline FbxObject* GetSrcObject(FbxClassId pClassId, int pIndex=0) const { return RootProperty.GetSrcObject(pClassId,pIndex); }
		...
		/** Returns the source object of the specified class type that satisfies the given criteria at the specified index.
		  ...
		  */
		inline FbxObject* GetSrcObject(FbxClassId pClassId, const FbxCriteria& pCriteria, int pIndex=0) const { return RootProperty.GetSrcObject(pClassId,pCriteria,pIndex); }
		...
		/** Searches the source object with the specified name which is also the specified class type, starting at the specified index.
		  ...
		  * \return The source object with the name, NULL if not found.
		  */
		inline FbxObject* FindSrcObject(FbxClassId pClassId, const char* pName, int pStartIndex=0) const { return RootProperty.FindSrcObject(pClassId,pName,pStartIndex); }
		...
		/** Searches the source object with the specified name which is the specified class type and satisfies the given criteria, starting at the specified index.
		  ...
		  * \return The source object with the name, NULL if not found.
		  */
		inline FbxObject* FindSrcObject(FbxClassId pClassId, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const { return RootProperty.FindSrcObject(pClassId,pCriteria,pName,pStartIndex); }

		/** Disconnects this object from all source objects of the specified class type.
		  * \param pFBX_TYPE The specified class type.
		  * \return \c True if it disconnects all source objects successfully, \c false otherwise.
		  */
		template <class T> inline bool DisconnectAllSrcObject(const T* pFBX_TYPE) { return RootProperty.DisconnectAllSrcObject(pFBX_TYPE); }
		...
		/** Disconnects this object from all source objects that are of the specified class type and that satisfy the given criteria.
		  ...
		  * \return \c True if it disconnects all source objects successfully, \c false otherwise.
		  */
		template <class T> inline bool DisconnectAllSrcObject(const T* pFBX_TYPE, const FbxCriteria& pCriteria) { return RootProperty.DisconnectAllSrcObject(pFBX_TYPE,pCriteria); }
		...
		/** Returns the number of source objects of a specific class type with which this object connects. 
		  ...
		  */
		template <class T> inline int GetSrcObjectCount(const T* pFBX_TYPE) const { return RootProperty.GetSrcObjectCount(pFBX_TYPE); }
		...
		*/
		template <class T> inline int GetSrcObjectCount(const T* pFBX_TYPE, const FbxCriteria& pCriteria) const { return RootProperty.GetSrcObjectCount(pFBX_TYPE,pCriteria); }
		...
		/** Returns the source object of the specified class type at the specified index.
		  ...
		  */
		template <class T> inline T* GetSrcObject(const T* pFBX_TYPE, int pIndex=0) const { return RootProperty.GetSrcObject(pFBX_TYPE,pIndex); }
		...
		/** Returns the source object that is the specified class type and that satisfies the given criteria at the specified index.
		  ...
		  */
		template <class T> inline T* GetSrcObject(const T* pFBX_TYPE, const FbxCriteria& pCriteria, int pIndex=0) const { return RootProperty.GetSrcObject(pFBX_TYPE,pCriteria,pIndex); }
		...
		/** Searches the source object with the specified name that is the specified class type, starting at the specified index.
		  ...
		  * \return The source object with the name, NULL if not found.
		  */
		template <class T> inline T* FindSrcObject(const T* pFBX_TYPE, const char* pName, int pStartIndex=0) const { return RootProperty.FindSrcObject(pFBX_TYPE,pName,pStartIndex); }
		...
		/** Searches the source object with the specified name that is the specified class type and that satisfies the given criteria, starting at the specified index.
		  ...
		  * \return The source object with the name, NULL if not found.
		  */
		template <class T> inline T* FindSrcObject(const T* pFBX_TYPE, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const { return RootProperty.FindSrcObject(pFBX_TYPE,pCriteria,pName,pStartIndex); }
		...
		/** Disconnects this object from all destination objects of the specified class type.
		  ...
		  */
		inline bool DisconnectAllDstObject(FbxClassId pClassId) { return RootProperty.DisconnectAllDstObject(pClassId); }
		...
		/** Disconnects this object from all the destination objects that are the specified class type and that satisfy the given criteria.
		  ...
		  */
		inline bool DisconnectAllDstObject(FbxClassId pClassId, const FbxCriteria& pCriteria) { return RootProperty.DisconnectAllDstObject(pClassId,pCriteria); }
		...
		/** Returns the number of destination objects of the specified class type with which this object connects. 
		  ...
		  */
		inline int GetDstObjectCount(FbxClassId pClassId) const { return RootProperty.GetDstObjectCount(pClassId); }
		...
		/** Returns the number of destination objects of the specified class type with which this object connects that also satisfy the given criteria . 
		  ...
		  */
		inline int GetDstObjectCount(FbxClassId pClassId, const FbxCriteria& pCriteria) const { return RootProperty.GetDstObjectCount(pClassId,pCriteria); }
		...
		/** Returns the destination object of the specified class type with which this object connects at the specified index.
		  ...
		  */
		inline FbxObject* GetDstObject(FbxClassId pClassId, int pIndex=0) const { return RootProperty.GetDstObject(pClassId,pIndex); }
		...
		/** Returns the destination object with which this object connects that is of the specified class type and that satisfies the given criteria at the specified index.
		  ...
		  */
		inline FbxObject* GetDstObject(FbxClassId pClassId, const FbxCriteria& pCriteria, int pIndex=0) const { return RootProperty.GetDstObject(pClassId,pCriteria,pIndex); }
		...
		/** Searches the destination object with the specified name which is the specified class type, starting at the specified index.
		  ...
		  * \return The destination object with the name, NULL if not found.
		  */
		inline FbxObject* FindDstObject(FbxClassId pClassId, const char* pName,int pStartIndex=0) const { return RootProperty.FindDstObject(pClassId,pName,pStartIndex); }
		...
		/** Searches the destination object with the specified name that is the specified class type and that satisfies the given criteria, starting at the specified index.
		  ...
		  * \return The destination object with the name, NULL if not found.
		  */
		inline FbxObject* FindDstObject(FbxClassId pClassId, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const { return RootProperty.FindDstObject(pClassId,pCriteria,pName,pStartIndex); }

		/** Disconnects this object from all destination objects of the specified class type.
		  * \param pFBX_TYPE The specified class type.
		  * \return \c True if it disconnects all destination objects of the specified class type successfully, \c false otherwise.
		  */
		template <class T> inline bool DisconnectAllDstObject(const T* pFBX_TYPE) { return RootProperty.DisconnectAllDstObject(pFBX_TYPE); }
		...
		/** Disconnects this object from all destination objects that are the specified class type and that satisfy the given criteria.
		  ...
		  * \return \c True if it disconnects all destination objects successfully, \c false otherwise.
		  */
		template <class T> inline bool DisconnectAllDstObject(const T* pFBX_TYPE, const FbxCriteria& pCriteria) { return RootProperty.DisconnectAllDstObject(pFBX_TYPE,pCriteria); }

		/** Returns the number of destination objects of the specified class type with which this object connects. 
		  * \param pFBX_TYPE The specified class type.
		  * \return The number of destination objects of the specified class type with which this object connects. 
		  */
		template <class T> inline int GetDstObjectCount(const T* pFBX_TYPE) const { return RootProperty.GetDstObjectCount(pFBX_TYPE); }
		...
		/** Returns the number of destination objects with which this object connects that are the specified class type and that satisfy the given criteria. 
		  ...
		  * \return The number of destination objects that are the specified class type and that satisfy the given criteria. 
		  */
		template <class T> inline int GetDstObjectCount(const T* pFBX_TYPE, const FbxCriteria& pCriteria) const { return RootProperty.GetDstObjectCount(pFBX_TYPE,pCriteria); }
		...
		/** Returns the destination object with which this object connects that is the specified class type at the specified index.
		  ...
		  * \return The destination object of the specified class type at the specified index, NULL if not found.
		  */
		template <class T> inline T* GetDstObject(const T* pFBX_TYPE, int pIndex=0) const { return RootProperty.GetDstObject(pFBX_TYPE,pIndex); }
		...
		/** Returns the destination object with which this object connects that is the specified class type and that satisfies the given criteria at the specified index.
		  ...
		  */
		template <class T> inline T* GetDstObject(const T * pFBX_TYPE, const FbxCriteria& pCriteria, int pIndex=0) const { return RootProperty.GetDstObject(pFBX_TYPE,pCriteria,pIndex); }
		...
		/** Searches the destination object with the specified name which is of the specified class type, starting at the specified index.
		  ...
		  * \return The source object with the name, NULL if not found.
		  */
		template <class T> inline T* FindDstObject(const T* pFBX_TYPE, const char* pName, int pStartIndex=0) const { return RootProperty.FindDstObject(pFBX_TYPE,pName,pStartIndex); }
		...
		/** Searches the destination object with the specified name that is the specified class type and that satisfies the given criteria, starting at the specified index.
		  ...
		  * \return The source object with the name, NULL if not found.
		  */
		template <class T> inline T* FindDstObject(const T* pFBX_TYPE, const FbxCriteria& pCriteria, const char* pName, int pStartIndex=0) const { return RootProperty.FindDstObject(pFBX_TYPE,pCriteria,pName,pStartIndex); }
	//@}
...
protected:
    ...
    // FbxObject::Construct first. Note that property initialization
    ...
    // Initialize the FbxProperty member variables of this class.
...
inline bool FbxConnectSrc(FbxObject* pDstObject, FbxObject* pSrcObject)   { return (pSrcObject && pDstObject) ? pDstObject->ConnectSrcObject(pSrcObject) : 0; }
inline bool FbxConnectDst(FbxObject* pSrcObject, FbxObject* pDstObject)   { return (pSrcObject && pDstObject) ? pSrcObject->ConnectDstObject(pDstObject) : 0; }

// template access functions SRC
template < class T > inline int FbxGetSrcCount(const FbxObject* pObject)                                                      { return pObject ? pObject->GetSrcObjectCount(T::ClassId) : 0; }
template < class T > inline int FbxGetSrcCount(const FbxObject* pObject, FbxClassId pClassId)                                { return pObject ? pObject->GetSrcObjectCount(pClassId) : 0;     }
template < class T > inline T* FbxGetSrc(const FbxObject* pObject, int pIndex=0)                                              { return pObject ? (T *) pObject->GetSrcObject(T::ClassId,pIndex) : 0; }
template < class T > inline T* FbxGetSrc(const FbxObject* pObject, int pIndex, FbxClassId pClassId)                          { return pObject ? (T *) pObject->GetSrcObject(pClassId,pIndex) : 0;    }
template < class T > inline T* FbxFindSrc(const FbxObject* pObject, const char* pName, int pIndex=0)                          { return pObject ? (T *) pObject->FindSrcObject(T::ClassId,pName,pIndex) : 0;   }
template < class T > inline T* FbxFindSrc(const FbxObject* pObject, const char* pName, FbxClassId pClassId, int pIndex=0)    { return pObject ? (T *) pObject->FindSrcObject(pClassId,pName,pIndex) : 0; }

template < class T > inline bool FbxDisconnectAllSrc(FbxObject *pObject)                                                      { return pObject->DisconnectAllSrcObject(T::ClassId);   }

// template access functions DST
template < class T > inline int FbxGetDstCount(const FbxObject* pObject)                                                      { return pObject ? pObject->GetDstObjectCount(T::ClassId) : 0; }
template < class T > inline int FbxGetDstCount(const FbxObject* pObject, FbxClassId pClassId)                                { return pObject ? pObject->GetDstObjectCount(pClassId) : 0;     }
template < class T > inline T* FbxGetDst(const FbxObject* pObject, int pIndex=0)                                              { return pObject ? (T *) pObject->GetDstObject(T::ClassId,pIndex) : 0; }
template < class T > inline T* FbxGetDst(const FbxObject* pObject, int pIndex, FbxClassId pClassId)                          { return pObject ? (T *) pObject->GetDstObject(pClassId,pIndex) : 0;    }
template < class T > inline T* FbxFindDst(const FbxObject* pObject, const char* pName, int pIndex=0)                          { return pObject ? (T *) pObject->FindDstObject(T::ClassId,pName,pIndex) : 0;   }
template < class T > inline T* FbxFindDst(const FbxObject* pObject, const char* pName, FbxClassId pClassId, int pIndex=0)    { return pObject ? (T *) pObject->FindDstObject(pClassId,pName,pIndex) : 0; }

template < class T > inline bool FbxDisconnectAllDst(const FbxObject* pObject)                                                { return pObject->DisconnectAllDstObject(T::ClassId);   }
