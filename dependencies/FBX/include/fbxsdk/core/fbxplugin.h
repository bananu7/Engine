...
public:
	inline FbxObject& GetPluginSettings() { return *(mPluginSettings.Get()); }
	inline const FbxObject& GetPluginSettings() const { return *(mPluginSettings.Get()); }
...
private:
	...
	FbxObjectScopedPtr<FbxObject>	mPluginSettings;
